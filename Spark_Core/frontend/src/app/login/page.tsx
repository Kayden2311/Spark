...
function LoginForm() {
  ...
  return (
    <div className="loginPageRoot">
      <div className="loginAmbientGrid" aria-hidden="true" />
      <div className="loginAmbientOrb1" aria-hidden="true" />
      <div className="loginAmbientOrb2" aria-hidden="true" />

      <div className="loginCardWrapper">
        {/* Brand Lockup */}
        <Link href="/" className="loginBrandLockup" aria-label="Spark home">
          <div className="loginBrandBolt">
            <svg viewBox="0 0 48 48">
              <path d="M27 2 8 27h13l-2 19 21-27H27z" />
            </svg>
          </div>
          <span className="loginBrandName">Spark</span>
        </Link>

        <h1 className="loginHeading">Sign in to Spark</h1>
        ...
        <div className="oauthButtonGroup">
          <button
            type="button"
            className="oauthBtn"
            onClick={() => setError("GitHub OAuth is configured in enterprise SSO settings.")}
          >
            <GitHubIcon />
            <span>GitHub</span>
          </button>
          <button
            type="button"
            className="oauthBtn"
            onClick={() => setError("Google OAuth is configured in enterprise SSO settings.")}
          >
            <GoogleIcon />
            <span>Google</span>
          </button>
        ...
        <form onSubmit={handleSubmit} className="authForm" noValidate>
          ...
          <div className="authField">
            <div className="authLabelRow">
              ...
              <a href="#reset" className="authForgotLink" onClick={(e) => { e.preventDefault(); setError("Password reset link will be sent to your verified work email."); }}>
                Forgot password?
              </a>
            </div>
            <div className="authInputWrapper">
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="loginPageRoot">
          <div className="loginCardWrapper" style={{ textAlign: "center", color: "#94a3b8" }}>
            Loading Spark Auth...
          </div>
        </div>
      }
