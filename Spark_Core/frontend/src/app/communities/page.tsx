...
export default function CommunitiesPage() {
  return <main className="communityExplorer">
    <header className="communityHeader"><Link className="communityBrand" href="/">Spark</Link><nav aria-label="Main navigation"><Link href="/">Home</Link><Link aria-current="page" href="/communities">Communities</Link><Link href="/pricing">Pricing</Link><Link href="/workspace">Workspace</Link></nav></header>
